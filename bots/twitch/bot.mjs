        ...
        this._setupEvents = function() {
            ...
            this.api.addListener('token_refreshed', data => {
                ...
                try {
                    ...
                    if (botIndex !== -1) {
                        currentSettings.twitch[botIndex].secrets.usertoken = data.usertoken;
